...
export default function DashboardPage() {
  ...
  const hotLeads = leads.filter((lead) => scoreLead(lead.last_contact).label === "Quente").length;
  const coldLeads = leads.filter((lead) => scoreLead(lead.last_contact).label === "Frio").length;
  ...
  const selectedLeadScore = selectedLead ? scoreLead(selectedLead.last_contact) : null;
            ...
            <Card>
              ...
              >
                ...
                <Button
                  variant="secondary"
                  onClick={() => {
                    navigator.clipboard.writeText(generateMessage(selectedLead.name));
                  }}
                >
                  Copiar mensagem
                </Button>
